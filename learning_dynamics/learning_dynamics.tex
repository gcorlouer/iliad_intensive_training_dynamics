...
\small
Learn a function $g$ from observations $y = g(x)$. Initialize neural weights at $\theta_0 \sim \mathcal{N}(0,\sigma^{-\gamma}I)$, with initialization scale $\gamma$ and $\sigma=d_L$.
...
Initialize weights: $\theta \sim \mathcal{N}(0,d_L^{-\gamma/2}I)$
\\
